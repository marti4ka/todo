...
public class ScannerFragment extends Fragment implements
		ScannerView.ScannerViewEventListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.zxscanlib_fragment_scanner,
				container, false);
		return rootView;
	}
	...
	public void setScannerViewEventListener(
			final ScannerView.ScannerViewEventListener scannerViewEventListener) {
