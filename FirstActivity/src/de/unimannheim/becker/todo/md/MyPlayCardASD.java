...
public class MyPlayCardASD extends RecyclableCard {
    ...
    public MyPlayCardASD(String titlePlay, String description, String color, String titleColor, Boolean hasOverflow,
			Boolean isClickable) {
		super(titlePlay, description, color, titleColor, hasOverflow, isClickable);
	}
	
	public MyPlayCardASD(String titlePlay, String description, int id) {
...
//                                myMap.startAddingLocation(itemId);
                                // TODO call the AddLocationActivity with the itemId
                                // myMap.getMap() create on long press listener
                                return true;
                            case R.id.menu_edit:
                                return false;
                            default:
